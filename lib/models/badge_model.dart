...
class BadgeModel {
  ...
  static List<BadgeModel> defaultBadges() {
    return const <BadgeModel>[
      BadgeModel(
        id: 'badge_7',
        title: 'Khoi Dau Hoan Hao',
        description: 'Dat chuoi 7 ngay lien tuc.',
        milestoneDays: 7,
        tier: BadgeTier.bronze,
      ),
      BadgeModel(
        id: 'badge_21',
        title: 'Thoi Quen Hinh Thanh',
        description: 'Dat chuoi 21 ngay lien tuc.',
        milestoneDays: 21,
        tier: BadgeTier.silver,
      ),
      BadgeModel(
        id: 'badge_30',
        title: 'Kien Tri Ben Bi',
        description: 'Dat chuoi 30 ngay lien tuc.',
        milestoneDays: 30,
        tier: BadgeTier.gold,
      ),
      BadgeModel(
        id: 'badge_100',
        title: 'Ky Luat Thep',
        description: 'Dat chuoi 100 ngay lien tuc.',
        milestoneDays: 100,
